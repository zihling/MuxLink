...
TRAIN_LOG="Log_train_${CIRCUIT}_K${KEY_SIZE}_ISO.txt"
PRED_LOG_POS="Log_pos_predict_${CIRCUIT}_K${KEY_SIZE}_ISO.txt"
PRED_LOG_NEG="Log_neg_predict_${CIRCUIT}_K${KEY_SIZE}_ISO.txt"
...
python Main.py \
    --file-name "${CIRCUIT}_K${KEY_SIZE}_ISO" \
